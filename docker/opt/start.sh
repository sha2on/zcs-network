...
echo "Downloading Zimbra Collaboration 8.7.3"
wget -O /opt/zimbra-install/zcs-NETWORK-8.7.3_GA_1750.UBUNTU16_64.20170215042321.tgz https://files.zimbra.com/downloads/8.7.3_GA/zcs-NETWORK-8.7.3_GA_1750.UBUNTU16_64.20170215042321.tgz

echo "Extracting files from the archive"
tar xzvf /opt/zimbra-install/zcs-NETWORK-8.7.3_GA_1750.UBUNTU16_64.20170215042321.tgz -C /opt/zimbra-install/
